...
''' <summary>Decimalのデータ型を表現するクラスです。</summary>
Public NotInheritable Class DecimalDataType
    Inherits DataType
    ...
    Public Overrides Function CanTo(input As String) As Boolean
        ...
        Else
            Dim tmp As Decimal
            Return Decimal.TryParse(input, tmp)
        End If
    End Function
    ...
    Public Overrides Function ToValue(input As String) As Object
        ...
        Else
            Dim tmp As Decimal
            If Decimal.TryParse(input, tmp) Then
                Return tmp
            Else
                Throw New FormatException($"unable to convert ""{input}"" to decimal")
            End If
        End If
    End Function
