...
''' <summary>整数のデータ型を表現するクラスです。</summary>
Public NotInheritable Class IntegerDataType
    Inherits DataType
    ...
    Public Overrides Function CanTo(input As String) As Boolean
        ...
        Else
            Dim tmp As Integer
            Return Integer.TryParse(input, tmp)
        End If
    End Function
    ...
    Public Overrides Function ToValue(input As String) As Object
        ...
        Else
            ...
            If Integer.TryParse(input, tmp) Then
                Return tmp
            Else
                Throw New FormatException($"unable to convert ""{input}"" to integer")
            End If
        End If
    End Function
