...
Public NotInheritable Class ShortDataType
    Inherits DataType
    ...
    Public Overrides Function CanTo(input As String) As Boolean
        ...
        Else
            Dim tmp As Short
            Return Short.TryParse(input, tmp)
        End If
    End Function
    ...
    Public Overrides Function ToValue(input As String) As Object
        ...
        Else
            Dim tmp As Short
            If Short.TryParse(input, tmp) Then
                Return tmp
            Else
                Throw New FormatException($"unable to convert ""{input}"" to short")
            End If
        End If
    End Function
