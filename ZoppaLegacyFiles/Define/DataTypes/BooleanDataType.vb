...
''' <summary>真偽値のデータ型を表現するクラスです。</summary>
Public NotInheritable Class BooleanDataType
    Inherits DataType
    ...
    Public Overrides Function CanTo(input As String) As Boolean
        ...
        Else
            Dim tmp As Boolean
            Return Boolean.TryParse(input, tmp)
        End If
    End Function
    ...
    Public Overrides Function ToValue(input As String) As Object
        ...
        Else
            Dim tmp As Boolean
            If Boolean.TryParse(input, tmp) Then
                Return tmp
            Else
                Throw New FormatException($"unable to convert ""{input}"" to boolean")
            End If
        End If
    End Function
